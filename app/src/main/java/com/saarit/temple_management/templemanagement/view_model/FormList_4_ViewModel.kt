...
class FormList_4_ViewModel(application: Application) : AndroidViewModel(application) {
    private val TAG = FormList_4_ViewModel::class.java.simpleName
    ...
    public fun fetchTempleIDs() {
        Repo_FormType_4.getInstance(getApplication()).getAllTempleIds().
