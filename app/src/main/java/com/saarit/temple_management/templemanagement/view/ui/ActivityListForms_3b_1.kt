...
class ActivityListForms_3b_1 : AppCompatActivity() {

    val TAG = ActivityListForms_3b_1::class.java.simpleName

    lateinit var binding : ActivityListForms3b1Binding
    lateinit var viewModel : FormList_3b_1_ViewModel
    ...
    private fun setupBindings(savedInstanceState: Bundle?) {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_list_forms_3b_1)
        viewModel = ViewModelProviders.of(this).get(FormList_3b_1_ViewModel::class.java)
    ...
    private fun setUpObservers() {
        viewModel.observe_temple_to_open().observe(
                ...
                Observer<Int> { templeId: Int? ->
                    ...
                    var intent = Intent(this, Form3b_1Activity::class.java)
