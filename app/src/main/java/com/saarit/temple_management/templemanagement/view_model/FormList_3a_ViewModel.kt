...
class FormList_3a_ViewModel(application: Application) : AndroidViewModel(application) {
    private val TAG = FormList_3a_ViewModel::class.java.simpleName
    ...
    public fun fetchTempleIDs() {
        Repo_FormType_3a.getInstance(getApplication()).getAllTempleIds().
