...
class FormList_3b_1_ViewModel(application: Application) : AndroidViewModel(application) {
    private val TAG = FormList_3b_1_ViewModel::class.java.simpleName
    ...
    public fun fetchTempleIDs() {
        Repo_FormType_3b_1.getInstance(getApplication()).getAllTempleIds().
