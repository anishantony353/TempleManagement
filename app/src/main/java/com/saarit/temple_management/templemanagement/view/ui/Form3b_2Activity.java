...
import com.saarit.temple_management.templemanagement.databinding.ActivityForm3b2Binding;
...
public class Form3b_2Activity extends AppCompatActivity implements DateSetListner {

    private String TAG = Form3b_2Activity.class.getSimpleName();

    ActivityForm3b2Binding binding;

    FormType3b_2_ViewModel viewModel;
    ...
    private void setupBindings(Bundle savedInstanceState) {
        binding = DataBindingUtil.setContentView(this,R.layout.activity_form3b_2);
        viewModel = ViewModelProviders.of(this).get(FormType3b_2_ViewModel.class);
