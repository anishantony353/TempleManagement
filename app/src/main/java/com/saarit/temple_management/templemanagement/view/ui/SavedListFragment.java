...
import com.saarit.temple_management.templemanagement.databinding.FragmentSavedListBinding;
...
public class SavedListFragment extends Fragment {
    ...
    private String TAG = SavedListFragment.class.getSimpleName();
    ...
    private void setupBindings(FragmentSavedListBinding binding, Bundle savedInstanceState) {

        //ActivityDogBreedsBinding activityBinding = DataBindingUtil.setContentView(this, R.layout.activity_dog_breeds);
        viewModel = ViewModelProviders.of(this).get(SavedListViewModel.class);
