...
public interface Temples_master_Dao {
    ...
    @Query("SELECT * FROM Temple_master WHERE temple_id NOT IN (SELECT temple_id from FormType_1 where temple_id != :templeId)")
    Single<List<Temple_master>> getTemplesForSelection(int templeId);
